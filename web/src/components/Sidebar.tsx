        ...
        <List spacing={4} p={4}>
            <Flex role="group" alignItems="center" as={Link} to="/">
                ...
                <Heading
                    ...
                    fontWeight="500"
                    size="md"
                    color={pathname === '/' ? 'teal.500' : 'gray.400'} >Ínicio</Heading>
            </Flex>
            <Flex role="group" alignItems="center" as={Link} to="/groups">
                ...
                <Heading
                    ...
                    fontWeight="500"
                    size="md"
                    color={pathname.startsWith('/groups') ? 'teal.500' : 'gray.400'} >Coleções</Heading>
            </Flex>
            <Flex role="group" alignItems="center" as={Link} to="/products">
                ...
                <Heading
                    ...
                    fontWeight="500"
                    size="md"
                    color={pathname.startsWith('/products') ? 'teal.500' : 'gray.400'} >Produtos</Heading>
            </Flex>
            <Flex role="group" alignItems="center" as={Link} to="/fabrics">
                ...
                <Heading
                    ...
                    fontWeight="500"
                    size="md"
                    color={pathname.startsWith('/fabrics') ? 'teal.500' : 'gray.400'} >Tecidos</Heading>
            </Flex>
            <Flex role="group" alignItems="center" as={Link} to="/providers">
                ...
                <Heading
                    ...
                    fontWeight="500"
                    size="md"
                    color={pathname.startsWith('/providers') ? 'teal.500' : 'gray.400'} >Fornecedores</Heading>
            </Flex>
        </List>
    )
}
